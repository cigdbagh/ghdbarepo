...
#             This script runs from Tuesday-Sunday at 04:30
...
LOG_FILE="${LOG_PATH}"/"sp_fix_upd_decstatus_${SCHEMA}_${DBNAME}.lst"
TXT_FILE="${LOG_PATH}"/"sp_fix_upd_decstatus_${SCHEMA}_${DBNAME}.txt"
RM_LOG="${LOG_PATH}"/"rm_sp_fix_upd_decstatus_${S_HOST}.log"
...
MAIL_LOG_SUB1="Daily Data Fixes (${U_S_HOST}): ERROR on sp_fix_upd_decstatus in ${U_SCHEMA} of ${U_DBNAME}"
MAIL_LOG_SUB2="Daily Data Fixes (${U_S_HOST}): Sp_fix_upd_decstatus completed in ${U_SCHEMA} of ${U_DBNAME}"
RM_ERR="Daily Scripts (${U_S_HOST}): ERROR in removing sp_fix_upd_decstatus logs."
...
${SCHEMA}/${PWD}@${DBNAME}
spool ${LOG_FILE}
prompt Starting SP_FIX_UPD_DECSTATUS... 
