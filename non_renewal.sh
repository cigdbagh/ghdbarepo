...
LOG_FILE="${LOG_PATH}"/"NON_RENEWAL_${SCHEMA}_${DBNAME}.lst"
TXT_FILE="${LOG_PATH}"/"NON_RENEWAL_${SCHEMA}_${DBNAME}.txt"
RM_LOG="${LOG_PATH}"/"RM_NON_RENEWAL_${S_HOST}.log"
...
MAIL_LOG_TO_DBAGRP='${MAIL_LOG_TO_DBA} agrover@ciginsurance.com ssingh@ciginsurance.com'
MAIL_LOG_TO_USER="${MAIL_LOG_TO_DBA} agrover@ciginsurance.com ssingh@ciginsurance.com"

MAIL_LOG_SUB1="Daily Data Fixes (${U_S_HOST}): ERROR on PKG_NON_RENEWAL in ${U_SCHEMA} of ${U_DBNAME}"
MAIL_LOG_SUB2="Daily Data Fixes (${U_S_HOST}): PKG_NON_RENEWAL completed in ${U_SCHEMA} of ${U_DBNAME}"
RM_ERR="Daily Scripts (${U_S_HOST}): ERROR in removing PKG_NON_RENEWAL logs."
...
${SCHEMA}/${PWD}@${DBNAME}
spool ${LOG_FILE}
prompt Starting PKG_NON_RENEWAL... 
