...
LOG_FILE="${LOG_PATH}"/"NR_FOR_COMM_AND_FARM_${SCHEMA}_${DBNAME}.lst"
TXT_FILE="${LOG_PATH}"/"NR_FOR_COMM_AND_FARM_${SCHEMA}_${DBNAME}.txt"
RM_LOG="${LOG_PATH}"/"RM_NR_FOR_COMM_AND_FARM_${S_HOST}.log"
...
MAIL_LOG_TO_DBAGRP='${MAIL_LOG_TO_DBA} agrover@ciginsurance.com ssingh@ciginsurance.com kkleven@ciginsurance.com'
MAIL_LOG_TO_USER="${MAIL_LOG_TO_DBA} agrover@ciginsurance.com ssingh@ciginsurance.com kkleven@ciginsurance.com"
#MAIL_LOG_TO_USER="agrover@ciginsurance.com, ssingh@ciginsurance.com,kkleven@ciginsurance.com"

MAIL_LOG_SUB1="Daily Data Fixes (${U_S_HOST}): ERROR on PKG_NR_FOR_COMM_AND_FARM in ${U_SCHEMA} of ${U_DBNAME}"
MAIL_LOG_SUB2="Daily Data Fixes (${U_S_HOST}): PKG_NR_FOR_COMM_AND_FARM COMPLETED in ${U_SCHEMA} of ${U_DBNAME}"
RM_ERR="Daily Scripts (${U_S_HOST}): ERROR in removing PKG_NR_FOR_COMM_AND_FARM logs."
...
${SCHEMA}/${PWD}@${DBNAME}
spool ${LOG_FILE}
prompt Starting NR_FOR_COMM_AND_FARM... 
...
execute PKG_NR_FOR_COMM_AND_FARM.SP_MAIN();
set time off timing off;
SELECT TO_CHAR(sysdate,'MM/DD/YY HH24:MI:SS') END_DATE from dual;
prompt PKG_NR_FOR_COMM_AND_FARM complete.
spool off;
END_SQL
