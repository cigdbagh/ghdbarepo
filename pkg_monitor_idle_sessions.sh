#!/bin/sh
# Name     :  pkg_monitor_idle_sessions.sh
# Author   :  Raman Paul 
# Created  :  05/10/10
...
SCR_FILE="${SCR_PATH}"/"check_idle_sessions.sql"
SCR_FILE2="${SCR_PATH}"/"ins_idle_sessions_report_scr.sql"
SCR_FILE3="${SCR_PATH}"/"gen_html_report.sql"
LOG_FILE2="${LOG_PATH}"/"check_idle_sessions_${SCHEMA}_${DBNAME}.lst"
TXT_FILE2="${LOG_PATH}"/"check_idle_sessions_${SCHEMA}_${DBNAME}.txt"
ERR_FILE2="${LOG_PATH}"/"check_idle_sessions_${SCHEMA}_${DBNAME}.err"

LOG_FILE="${LOG_PATH}"/"pkg_monitor_idle_sessions_${SCHEMA}_${DBNAME}.lst"
TXT_FILE="${LOG_PATH}"/"pkg_monitor_idle_sessions_${SCHEMA}_${DBNAME}.txt"

LOG_FILE3="${LOG_PATH}"/"ins_idle_sessions_report_${SCHEMA}_${DBNAME}.lst"
TXT_FILE3="${LOG_PATH}"/"ins_idle_sessions_report_${SCHEMA}_${DBNAME}.txt"

LOG_FILE4="${LOG_PATH}"/"gen_html_report_${SCHEMA}_${DBNAME}.lst"
TXT_FILE4="${LOG_PATH}"/"gen_html_report_${SCHEMA}_${DBNAME}.txt"

RM_LOG="${LOG_PATH}"/"rm_pkg_monitor_idle_sessions_${S_HOST}.log"
UTL_FILE="${INTERFACES}"/"idle_session_log.html"
...
MAIL_LOG_SUB1="Daily Script (${U_S_HOST}): ERROR on pkg_monitor_idle_sessions in ${U_SCHEMA} of ${U_DBNAME}"
MAIL_LOG_SUB2="Daily Data Script (${U_S_HOST}): Pkg_monitor_idle_sessions completed in ${U_SCHEMA} of ${U_DBNAME}"
RM_ERR="Daily Script (${U_S_HOST}): ERROR in pkg_monitor_idle_sessions logs."
...
execute PKG_MONITOR_IDLE_SESSIONS.sp_monitor_idle;  
