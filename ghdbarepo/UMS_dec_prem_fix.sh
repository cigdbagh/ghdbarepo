...
LOG_FILE="${LOG_PATH}"/"UMS_DEC_PREM_FIX_${SCHEMA}_${DBNAME}.lst"
TXT_FILE="${LOG_PATH}"/"UMS_DEC_PREM_FIX_${SCHEMA}_${DBNAME}.txt"
RM_LOG="${LOG_PATH}"/"RM_UMS_DEC_PREM_FIX_${S_HOST}.log"
...
MAIL_LOG_TO_USER="${MAIL_LOG_TO_DBA} UMSTeamNotify@ciginsurance.com bmoganti@ciginsurance.com"

MAIL_LOG_SUB1="Daily Data Fixes (${U_S_HOST}): ERROR on UMS_DEC_PREM_FIX in ${U_SCHEMA} of ${U_DBNAME}"
MAIL_LOG_SUB2="Daily Data Fixes (${U_S_HOST}): UMS_DEC_PREM_FIX completed in ${U_SCHEMA} of ${U_DBNAME}"
RM_ERR="Daily Scripts (${U_S_HOST}): ERROR in removing UMS_DEC_PREM_FIX logs."
...
${SCHEMA}/${PWD}@${DBNAME}
spool ${LOG_FILE}
prompt Starting UMS_DEC_PREM_FIX  ... 
